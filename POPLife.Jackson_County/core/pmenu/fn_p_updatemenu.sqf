...
_mstatus ctrlSetStructuredText parseText format["<t size='1.2px'>%1€</t>",[medel_atmdin] call life_fnc_numberText];
_mstatus2 ctrlSetStructuredText parseText format["<t size='1.2'>%1€</t>",[medel_din] call life_fnc_numberText];
