...
if(isNil "_data") exitWith {_list lbAdd "No tiene crimenes";};
if(typeName _data != "ARRAY") exitWith {_list lbAdd "No tiene crimenes";};
if(count _data == 0) exitWith {_list lbAdd "No tiene crimenes";};
lbClear _list;
