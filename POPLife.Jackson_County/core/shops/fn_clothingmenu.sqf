...
if((_this select 3) == "ems" && playerSide != independent) exitWith {hint "No eres EMS"; closeDialog 0;};
if((_this select 3) == "donator" && playerSide != civilian) exitWith {hint "No eres Donador"; closeDialog 0;};
if((_this select 3) == "militar" && playerSide != west) exitWith {hint "No eres Militar"; closeDialog 0;};
