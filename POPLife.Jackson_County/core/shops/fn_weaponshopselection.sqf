	...
	else
{
	...
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Price: <t color='#ff0000'>$%1</t><br/>Te Falta: <t color='#8cff9b'>$%2</t></t>",[(_price)] call life_fnc_numberText,[(_price - medel_din)] call life_fnc_numberText];
	}
		else
	{
