...
//if(!createDialog "Life_Vehicle_Shop_v2") exitWith {}; // ANTIGUO SIN 3D
if(!createDialog "Life_Vehicle_Shop_v2_3D") exitWith {}; // TIENDA 3D
...
[] call life_fnc_vehicleShopInit3DPreview; // tienda 3d
((findDisplay 2300) displayCtrl 2302) lbSetCurSel 0; // tienda 3d