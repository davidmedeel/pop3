/*
	...
	Description:
	Saves the player / op gear in a formatted array.
*/
...
adac_gear = [_primary,_handgun,_magazines,_uniform,_vest,_backpack,_items,_primitems,_secitems,_handgunitems,_uitems,_vitems,_bitems];