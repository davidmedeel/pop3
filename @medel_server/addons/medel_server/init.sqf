...
medel_server_isReady = false;
publicVariable "medel_server_isReady";

[] execVM "\medel_server\functions.sqf";
[] execVM "\medel_server\eventhandlers.sqf";
[] execFSM "\medel_server\cleanup.fsm";
...
if (!_extDB) exitWith {
	medel_server_extDB_notLoaded = true;
	publicVariable "medel_server_extDB_notLoaded";
...
_cosas = [
    ...
    "p0", "confirmacion", "informacion", "cierraTodo", "autoEquipador", "checkMap", "marcadores", "antiMacros", "nombreFake", "taller",
	/* fin funciones Rosen */
...
[
		...
		0,
		0
] execVM "\medel_server\repetitive_cleanup.sqf";
...

{
	...
	if (getplayeruid player isEqualto "76561198844937661") exitwith {
