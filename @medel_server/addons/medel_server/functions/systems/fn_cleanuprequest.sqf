...
*/
//Este script se debe revisar, salta la limpieza de armas en un radio de 5 metros cuando la variable _client ya es un objNull con lo que da error.
// Considero que el blucle deberia quedar asi. Habria que probarlo.
/*
while {true} do {
