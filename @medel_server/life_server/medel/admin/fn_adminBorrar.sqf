...
if (cursorObject isKindOf "Land_Billboard_F") exitWith {};
if (cursorObject isKindOf "cl3_club7") exitWith {};
if (cursorObject isKindOf "Land_em_medical_center_01") exitWith {};
